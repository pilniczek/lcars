...
Many recreations of LCARS exist as static graphics or as Flash animations. This project shows that one can develop a responsive LCARS interface entirely with modern web technologies. It is built completely in **React** with styling in **CSS Modules** (plus a small global ITCSS layer for resets, tokens, and layout). The interface responds to fit any screen and collapses to a minimal form for mobile devices. Even works on [PADDs](https://memory-alpha.fandom.com/wiki/Personal_Access_Display_Device) (ahem, tablets)!
